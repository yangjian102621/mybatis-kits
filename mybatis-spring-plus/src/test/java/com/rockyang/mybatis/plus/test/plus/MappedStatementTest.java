...
public class MappedStatementTest extends AbstractMybatisTest {
	...
	public void testGetMapperStatement() throws Exception {
		...
		MappedStatement mappedStatement = configuration.getMappedStatement("com.rockyang.mybatis.plus.test.support" +
	...
	public void testSearchByConditionsMapper() throws Exception {
		...
		MappedStatement mappedStatement = configuration.getMappedStatement("com.rockyang.mybatis.plus.test.support.dao.mapper.UserMapper.searchByConditions");
