...
import com.ppblock.mybatis.spring.plus.support.ext.Restrictions;
...
public class MappedStatementTest extends AbstractMybatisTest {
	...
	public void testGetMapperStatement() throws Exception {
		...
		MappedStatement mappedStatement = configuration.getMappedStatement("com.ppblock.mybatis.plus.test.support.dao.mapper.UserMapper.selectUser");
	...
	public void testSearchByConditionsMapper() throws Exception {
		...
		MappedStatement mappedStatement = configuration.getMappedStatement("com.ppblock.mybatis.plus.test.support.dao.mapper.UserMapper.searchByConditions");
