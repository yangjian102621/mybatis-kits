...
public class MappedStatementTest extends AbstractMybatisTest {
	...
	public void testGetMapperStatement() throws Exception {
		...
		MappedStatement mappedStatement = configuration.getMappedStatement("com.aizone.mybatis.plus.test.support.mapper.UserMapper.get");
	...
	public void testSearchByConditionsMapper() throws Exception {
		...
		MappedStatement mappedStatement = configuration.getMappedStatement("com.aizone.mybatis.plus.test.support.mapper.UserMapper.searchByConditions");
